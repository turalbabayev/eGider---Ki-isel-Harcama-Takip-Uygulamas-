        ...
        NavigationStack {
            ...
            .overlay {
                if transactions.isEmpty {
                    ContentUnavailableView("Hiçbir İşlem Bulunamadı", systemImage: "xmark.seal")
                }
            }
        }
    }
        ...
        Chart {
            ForEach(chartGroups) { group in
                ForEach(group.categories) { chart  in
                    ...
                    .position(by: .value("Katagori", chart.category.rawValue), axis: .horizontal)
                    .foregroundStyle(by: .value("Katagori", chart.category.rawValue))
                }
            }
        }
